...
Zeone Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 24494.
...
However, in open source software such as Zeone Core, where everyone uses
...
pay attention to for reviewers of Zeone Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zeone Core uses tinyformat, which is type safe. Leave them out to avoid confusion
