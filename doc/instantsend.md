...
This mechanism has been integrated into Bitcore-Node-Zeone which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zeonecoin/insight-api-zeone#web-socket-api](https://github.com/zeonecoin/insight-api-zeone#web-socket-api) 
* API: [https://github.com/zeonecoin/insight-api-zeone#instantsend-transactions](https://github.com/zeonecoin/insight-api-zeone#instantsend-transactions) 
...
By default, the Zeone Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zeone Core daemon:
