...
Only requiring some minor changes is zeone.cpp.
...
Changes to zeone.cpp
----------------------
zeone.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
