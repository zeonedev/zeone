...
{
    if(fLiteMode) return; // ignore all Zeone related functionality
...
/*
    ...
    allow endless transaction that would bloat Zeone and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("zeone-privatesend");
