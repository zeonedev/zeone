    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Zeone Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zeone address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zeone: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Zeone Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zeone Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zeone Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zeone addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zeone addresses"));
    ...
    openAction->setStatusTip(tr("Open a zeone: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zeone Core help message to get a list with possible Zeone Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zeone Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zeone network", "", count));
}
...
{
    QString strTitle = tr("Zeone Core"); // default title
