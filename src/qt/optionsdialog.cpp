    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ENZO-light"), QVariant("light"));
    ui->theme->addItem(QString("ENZO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ENZO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ENZO-traditional"), QVariant("trad"));
