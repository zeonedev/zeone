    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Zeone Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Zeone Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zeone-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Zeone in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ENZO, 0.1 ENZO, 1 ENZO and 10 ENZO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://zeonecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://zeonecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Zeone Core is shutting down...") + "<br /><br />" +
