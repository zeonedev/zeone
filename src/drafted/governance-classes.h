 ...
 *
 *   // network
 *   CZeoneNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zeone.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZeoneNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ZeoneNetwork
// //   -- signature requirements : Key1(User)
// class CZeoneNetworkVariable : public CGovernanceObject
// {
// private:
