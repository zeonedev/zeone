...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZeoneNetwork") type = ZeoneNetwork;
    if(strType == "ZeoneNetworkVariable") type = ZeoneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZeoneNetwork) s = "ZeoneNetwork";
    if(type == ZeoneNetworkVariable) s = "ZeoneNetworkVariable";
