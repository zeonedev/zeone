...
2. run zeoned with -printalert or -sendalert like this:
   /path/to/zeoned -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.zeone.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Zeone Core:0.12.0.58/"));
